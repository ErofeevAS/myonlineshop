...
import com.gmail.erofeev.st.alexei.myonlineshop.service.impl.DataBaseCreatorServiceImpl;
...
import com.gmail.erofeev.st.alexei.myonlineshop.servlet.command.impl.*;
    ...
    private void initDataBase() {
        if (!isDataBaseLoaded) {
            try {
                ...
                String fullPathTable = context.getRealPath(ConfigurationManagerImpl.getInstance().getProperty(ConfigurationManagerImpl.DATA_BASE_CREATE_TABLES));
                ...
                if (userService.getAmountOfUser() == 0) {
                    String fullPathData = context.getRealPath(ConfigurationManagerImpl.getInstance().getProperty(ConfigurationManagerImpl.DATA_BASE_INIT_TABLES));
